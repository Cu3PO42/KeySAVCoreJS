...
*
* Generated by DuoCode Compiler 1.3.1475.0 [Community]
*/
...
JS.Uint8ArrayHelper = $d.declare("JS.Uint8ArrayHelper", 0, $asm);
KeySAVCore.BattleVideoBreaker = $d.declare("KeySAVCore.BattleVideoBreaker", 0, $asm);
KeySAVCore.Structures.BattleVideoBreakResult = $d.declare("KeySAVCore.Structures.BattleVideoBreakResult", 
    0, $asm);
KeySAVCore.BattleVideoReader = $d.declare("KeySAVCore.BattleVideoReader", 0, $asm);
KeySAVCore.BitConverter = $d.declare("KeySAVCore.BitConverter", 0, $asm);
KeySAVCore.Convert = $d.declare("KeySAVCore.Convert", 0, $asm);
KeySAVCore.Exceptions.NoKeyException = $d.declare("KeySAVCore.Exceptions.NoKeyException", 0, $asm);
KeySAVCore.Exceptions.NoSaveException = $d.declare("KeySAVCore.Exceptions.NoSaveException", 0, $asm);
KeySAVCore.Exceptions.NoBattleVideoException = $d.declare("KeySAVCore.Exceptions.NoBattleVideoException", 
    0, $asm);
KeySAVCore.SaveBreaker = $d.declare("KeySAVCore.SaveBreaker", 0, $asm);
KeySAVCore.SaveReaderDecrypted = $d.declare("KeySAVCore.SaveReaderDecrypted", 0, $asm);
KeySAVCore.SaveReaderEncrypted = $d.declare("KeySAVCore.SaveReaderEncrypted", 0, $asm);
KeySAVCore.Utility = $d.declare("KeySAVCore.Utility", 0, $asm);
JS.TypedArray = $d.type("JS.TypedArray", 66, $asm, function($t, $p) {});
$d.define(JS.Uint8ArrayHelper, null, function($t, $p) {
...
$d.define(KeySAVCore.BattleVideoBreaker, null, function($t, $p) {
    $t.Load = function BattleVideoBreaker_Load(input, keyGetter, callback) {
        keyGetter(KeySAVCore.BitConverter.ToUInt32(input, 16), KeySAVCore.BitConverter.ToUInt32(input, 
            ...
            if (e == null)
                ...
                callback(e);
        }, this)), System.Action$2(System.Exception, Uint8Array, 63543)));
    };
...
$d.define(KeySAVCore.Structures.BattleVideoBreakResult, null, function($t, $p) {
    $t.$ator = function() {
        this.success = false;
        this.result = null;
        this.key = null;
...
$d.define(KeySAVCore.BattleVideoReader, null, function($t, $p) {
    $t.cctor = function() {
        $t.offset = 19992;
        $t.keyoff = 256;
    };
...
$d.define(KeySAVCore.BitConverter, null, function($t, $p) {
...
$d.define(KeySAVCore.Convert, null, function($t, $p) {
...
$d.define(KeySAVCore.Exceptions.NoKeyException, System.Exception, function($t, $p) {
    $t.ctor = function NoKeyException() {
        $t.$baseType.ctor.call(this);
    };
    $t.ctor.prototype = $p;
});
$d.define(KeySAVCore.Exceptions.NoSaveException, System.Exception, function($t, $p) {
    $t.ctor = function NoSaveException() {
        $t.$baseType.ctor.call(this);
    };
    $t.ctor.prototype = $p;
});
$d.define(KeySAVCore.Exceptions.NoBattleVideoException, System.Exception, function($t, $p) {
    $t.ctor = function NoBattleVideoException() {
        $t.$baseType.ctor.call(this);
    };
    $t.ctor.prototype = $p;
});
KeySAVCore.ISaveReader = $d.type("KeySAVCore.ISaveReader", 66, $asm, function($t, $p) {});
KeySAVCore.Structures.PKX = $d.type("KeySAVCore.Structures.PKX", 62, $asm, function($t, $p) {
    $t.ctor = function PKX() {
        this.ec = 0;
        this.pid = 0;
        this.exp = 0;
...
$d.define(KeySAVCore.SaveBreaker, null, function($t, $p) {
    $t.cctor = function() {
        $t.Magic = 1111835974;
        $t.eggnames = null;
        ...
        if (input.length == 1048576) {
            keyGetter(KeySAVCore.BitConverter.ToUInt32(input, 16), KeySAVCore.BitConverter.ToUInt32(input, 
                ...
                if (e == null)
                    ...
                    callback(e);
            }, this)), System.Action$2(System.Exception, KeySAVCore.Structures.SaveKey, 27496)));
            return;
        }
    ...
    $t.Break = function SaveBreaker_Break(break1, break2, keyGetter, callback) {
        ...
        if (!KeySAVCore.Utility.SequenceEqual$2(break1, 16, break2, 16, 8)) {
            callback(new KeySAVCore.Structures.SaveBreakResult.ctor$1(false, "Saves are not from the same game!\nPlease follow the instructions.", 
                null, null));
            return;
        }

        if (KeySAVCore.Utility.SequenceEqual(break1, break2)) {
            callback(new KeySAVCore.Structures.SaveBreakResult.ctor$1(false, "The saves are identical.\nPlease follow the instructions.", 
                null, null));
            return;
        }
        ...
        keyGetter(KeySAVCore.BitConverter.ToUInt32(break1, 16), KeySAVCore.BitConverter.ToUInt32(break1, 
            ...
            if (e == null) {
                ...
                var reader1, reader2;
                reader1 = new KeySAVCore.SaveReaderEncrypted.ctor$1(break1, key);
                reader1.scanSlots();
                reader2 = new KeySAVCore.SaveReaderEncrypted.ctor$1(break2, key);
                reader2.scanSlots();

                callback(new KeySAVCore.Structures.SaveBreakResult.ctor$1(true, "Found old key. Based new keystream on that.\n\nPlease save new Keystream.", 
                    key, null));
                return;
            }
            if (KeySAVCore.Utility.SequenceEqual$2(break1, 524288, break2, 524288, 520192)) {
            ...
            (function() {
                var $ref2 = { value: break1 };
                var $ref3 = { value: break2 };
                var $result$ = KeySAVCore.Utility.Switch(Uint8Array, $ref2, $ref3);
                break1 = $ref2.value;
                break2 = $ref3.value;
                return $result$;
            }).call(this);
            ...
            if ((offset[0] == 0) || (offset[1] == 0)) {
                ...
                callback(new KeySAVCore.Structures.SaveBreakResult.ctor$1(false, result, null, null));
                return;
            }
            else {
                ...
                if (valid == 0) { // We didn't get any valid EC's where D was not in last. Tell the user to try again with different specimens.
                    ...
                    JS.Uint8ArrayHelper.Copy$1(KeySAVCore.BitConverter.GetBytes(offset[0]), 0, savkey, 
                        28, 4);
                        ...
                        if (KeySAVCore.Structures.PKX.verifyCHK(pkx2) && KeySAVCore.Convert.ToBoolean(KeySAVCore.BitConverter.ToUInt16(pkx2, 
                            ...
                            if (KeySAVCore.Structures.PKX.verifyCHK(pkx1) && KeySAVCore.Convert.ToBoolean(KeySAVCore.BitConverter.ToUInt16(pkx1, 
                                ...
                                if (KeySAVCore.Structures.PKX.verifyCHK(pkx2) && KeySAVCore.Convert.ToBoolean(KeySAVCore.BitConverter.ToUInt16(pkx2, 
                                    ...
                                    // Sigh...
                                    callback(new KeySAVCore.Structures.SaveBreakResult.ctor$1(false, 
                                        "", null, null));
                                    return;
                                }
                        }
            ...
            if (true) {
                ...
                for (var i = 0; i < 31; i++) {
                    for (var j = 0; j < 30; j++) {
                        JS.Uint8ArrayHelper.Copy(break1, offset[0] + i * 6960 /* 232 * 30 */ + j * 232, 
                            data1, 0, 232);
                        JS.Uint8ArrayHelper.Copy(break2, offset[0] + i * 6960 /* 232 * 30 */ + j * 232, 
                            data2, 0, 232);
                ...
                callback(new KeySAVCore.Structures.SaveBreakResult.ctor$1(true, result, tmp, pkx));
                return;
            }
        }, this)), System.Action$2(System.Exception, KeySAVCore.Structures.SaveKey, 27496)));
    };
});
KeySAVCore.Structures.SaveBreakResult = $d.type("KeySAVCore.Structures.SaveBreakResult", 62, $asm, function($t, $p) {
...
KeySAVCore.Structures.SaveKey = $d.type("KeySAVCore.Structures.SaveKey", 62, $asm, function($t, $p) {
    ...
    $t.ctor.prototype = $p;
    $p.get_stamp1 = function SaveKey_get_stamp1() {
        return this.key32[0];
    };
    $p.set_stamp1 = function SaveKey_set_stamp1(value) {
        this.key32[0] = value;
        return value;
    };
    $p.get_stamp2 = function SaveKey_get_stamp2() {
        return this.key32[1];
    };
    $p.set_stamp2 = function SaveKey_set_stamp2(value) {
        this.key32[1] = value;
        return value;
    };
    $p.get_boxOffset = function SaveKey_get_boxOffset() {
        return this.key32[7 /* 0x1C/4 */];
    };
    $p.set_boxOffset = function SaveKey_set_boxOffset(value) {
        this.key32[7 /* 0x1C/4 */] = value;
        return value;
    };
    $p.get_slot1Flag = function SaveKey_get_slot1Flag() {
        return this.key32[131072 /* 0x80000/4 */];
    };
    $p.set_slot1Flag = function SaveKey_set_slot1Flag(value) {
        this.key32[131072 /* 0x80000/4 */] = value;
        return value;
    };
    $p.get_magic = function SaveKey_get_magic() {
        return this.key32[2];
    };
    $p.set_magic = function SaveKey_set_magic(value) {
        this.key32[2] = value;
        return value;
    };
    $p.get_isNewKey = function SaveKey_get_isNewKey() {
        return !JS.Uint8ArrayHelper.Empty(this.slot1Key);
    };
    $t.ctor$1 = function SaveKey(key) {
        this.keyData = key;
        this.key32 = new Uint32Array(key.buffer, key.byteOffset, 185013);
        ...
        if (this.get_magic() != 1111835974) {
            this.set_magic(1111835974);
...
$d.define(KeySAVCore.SaveReaderDecrypted, null, function($t, $p) {
    ...
    $p.get_IsNewKey = function SaveReaderDecrypted_get_IsNewKey() {
        return true;
    };
    ...
    $p.KeySAVCore$ISaveReader$get_IsNewKey = $p.get_IsNewKey;
...
$d.define(KeySAVCore.SaveReaderEncrypted, null, function($t, $p) {
    $t.$intfs = [KeySAVCore.ISaveReader];
    $t.cctor = function() {
        $t.zeros = null;
        $t.ezeros = null;
    ...
    $p.get_IsNewKey = function SaveReaderEncrypted_get_IsNewKey() {
        return this.key.get_isNewKey();
    };
    $t.ctor = function SaveReaderEncrypted(file, key_) {
        ...
        if (this.key.get_slot1Flag() == KeySAVCore.BitConverter.ToUInt32(this.sav, 360) && this.key.get_isNewKey())
            this.activeSlot = 0;
        else
            this.activeSlot = 1;

        KeySAVCore.Utility.XorInPlace(this.sav, (this.key.get_boxOffset() | 0) - 520192, this.key.slot1Key, 
            0, 215760 /* 232*30*31 */);
    };
    $t.ctor.prototype = $p;
    $t.ctor$1 = function SaveReaderEncrypted(file, key) {
        ...
        if (key.get_slot1Flag() == KeySAVCore.BitConverter.ToUInt32(this.sav, 360))
            this.activeSlot = 0;
        else
            this.activeSlot = 1;

        KeySAVCore.Utility.XorInPlace(this.sav, (key.get_boxOffset() | 0) - 520192, key.slot1Key, 0, 
            215760 /* 232*30*31 */);
    };
    $t.ctor$1.prototype = $p;
    ...
    $p.getPkxRaw = function SaveReaderEncrypted_getPkxRaw(pos, slot, ghost) {
        ...
        var savOffset = ((keyOffset + this.key.get_boxOffset() - (1 - slot) * 520192) | 0);
...
$d.define(KeySAVCore.Utility, null, function($t, $p) {
